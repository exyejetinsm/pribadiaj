...
let xeonysticker = JSON.parse(
  fs.readFileSync("./Media/theme/Media-Store-Karne-Ke-Liye/sticker.json")
);
let xeonyaudio = JSON.parse(
  fs.readFileSync("./Media/theme/Media-Store-Karne-Ke-Liye/audio.json")
);
let xeonyimage = JSON.parse(
  fs.readFileSync("./Media/theme/Media-Store-Karne-Ke-Liye/image.json")
);
let xeonyvideo = JSON.parse(
  fs.readFileSync("./Media/theme/Media-Store-Karne-Ke-Liye/video.json")
);
  ...
  try {
    ...
    const fakestatus = {
      ...
      message: {
        imageMessage: {
          ...
          jpegThumbnail: fs.readFileSync("./Media/theme/cheemspic.jpg"),
          scansSidecar:
    ...
    if (isCmd) {
      data = await fetchJson(
        "https://api.countapi.xyz/hit/XeonBotInc-md/visits"
      );
      jumlahcmd = `${data.value}`;
      dataa = await fetchJson(
        `https://api.countapi.xyz/hit/XeonBotInc-md${moment
          .tz("Asia/Kolkata")
    ...
    if (db.data.settings[botNumber].autobio) {
      ...
      if (new Date() * 1 - setting.status > 1000) {
        ...
        await XeonBotInc.setStatus(
          `Bot Name : ${XeonBotInc.user.name} | Runtime : ${runtime(
            process.uptime()
          )} | By ${global.ownername}`
        );
    ...
    if (db.data.chats[m.chat].antilink) {
      if (budy.match(`chat.whatsapp.com`)) {
        ...
        if (!isBotAdmins)
          return m.reply(`${mess.botAdmin}, to kick the person who send link`);
        let gclink =
    ...
    const xezy = {
      key: {
        fromMe: false,
        participant: `0@s.whatsapp.net`,
        ...(from ? { remoteJid: "14169948404-1305080833@g.us" } : {}),
      },
      contextInfo: {
        ...
        externalAdReply: {
          ...
          sourceUrl: websitex,
          thumbnailUrl:
            "https://i.ibb.co/txS3dDZ/Screenshot-2022-1030-154916.jpg",
    ...
    const emote = (satu, dua) => {
      try {
        ...
        emoji.get(satu).then((emoji) => {
          const buttons = [
            { buttonId: "y", buttonText: { displayText: satu }, type: 1 },
          ];
          const buttonMessage = {
      ...
      case "suit":
        {
          ...
          if (m.mentionedJid[0] === m.sender)
            return m.reply(`Can't play with myself !`);
          if (!m.mentionedJid[0])
            return m.reply(
...
*Please* @${m.mentionedJid[0].split`@`[0]} *to type accept/reject*`;
 ...
 ⫹⫺ Via Pulsa ${global.pulsa}🍜`;
      ...
      case "holoh":
        if (!m.quoted && !text)
          throw `Send/reply text with caption ${prefix + command}`;
      ...
      case "can":
        {
          ...
          let buttons = [
            {
              buttonId: "hehehe",
              buttonText: { displayText: "PATIENT🗿" },
              type: 1,
            },
          ];
          await XeonBotInc.sendButtonText(m.chat, buttons, jawab, botname, m);
      ...
      case "runtime":
        {
          ...
          await XeonBotInc.sendButtonText(m.chat, buttons, lowq, botname, m, {
            quoted: fkontak,
          });
        }
        break;
      ...
      case "request":
        {
          ...
          await XeonBotInc.sendButtonText(
            ...
            botname,
            m,
            { mentions: ments, quoted: fdoc }
          );
          let akhji = `*Request has been sent*\n*To Owner @${
            ownernya.split("@")[0]
          }*\n_Thank you🙏_`;
          await XeonBotInc.sendButtonText(m.chat, buttons, akhji, botname, m, {
            mentions: ments,
            quoted: fkontak,
          });
        }
      ...
      case "vote":
        {
          ...
          if (!text)
            throw `Enter Reason for Vote, Example: *${
              prefix + command
            } Handsome Owner*`;
          m.reply(
      ...
      case "upvote":
        {
          if (!m.isGroup) throw mess.group;
          if (!(m.chat in vote))
            throw `_*no voting in this group!*_\n\n*${prefix}vote* - to start voting`;
...
`;
      ...
      case "antilinkgc":
        {
          ...
          if (args[0] === "on") {
            if (db.data.chats[m.chat].antilink)
              return m.reply(`*It's Been Active Before*`);
            db.data.chats[m.chat].antilink = true;
            m.reply(`*Antilink Now Active !*`);
          } else if (args[0] === "off") {
            if (!db.data.chats[m.chat].antilink)
              return m.reply(`*Not Activated Before*`);
      ...
      case "bug":
        {
          if (!text)
            throw `kalo kamu nemu pesan eror Silahkan ${
              prefix + command
            } pake perintah ini  contoh: #report selamat siang owner, Saya Menemukan Fitur eror`;
          let ownernya = ownernomer + "@s.whatsapp.net";
          let me = m.sender;
          let pjtxt = `Message From : @${me.split("@")[0]} \nFor : @${
            ownernya.split("@")[0]
      ...
      case "setmenu":
        {
          ...
          if (args[0] === "templateImage") {
            ...
            XeonBotInc.sendListMsg(
              m.chat,
              `pilih aja *${pushname}* the set menu!`,
              botname,
              `*Hello sis* !`,
              `Choose Set Menu`,
              sections,
      ...
      case "tts":
        {
          ...
          let tts = await fetchJson(
            `https://api.akuari.my.id/texttovoice/texttosound_en?query=${text}`
          );
          XeonBotInc.sendMessage(
            m.chat,
            {
      ...
      case "ytaudio":
        {
          ...
          if (media.filesize >= 100000)
            return m.reply("File Over Limit " + util.format(media));
          XeonBotInc.sendImage(
            m.chat,
            media.thumb,
            `⫹⫺ Title : ${media.title}\n⫹⫺ File Size : ${
      ...
      case "searchgc":
        {
          if (!text) throw "Enter Query Title";
          anu = await fetchJson(
            `https://api.akuari.my.id/search/carigc?query=${text}`
          );
          n = anu.result;
          ...
          await XeonBotInc.sendButtonText(m.chat, buttons, jwbn, botname, m, {
            quoted: fgclink,
          });
        }
        break;
...
Judul: ${judul} `,
      ...
      /* case 'tiktok': case 'tt':
            ...
            m.reply(mess.wait)
            let nih = `SUDAH KACK, TERIMAKASIH PADA : ${author}\nJangan Lupa Subscribenya dong https://youtube.com/@xyzlann1747`
            axios.get(`https://lanzzz-api.onrender.com/api/dowloader/tikok?url=${args[0]}&apikey=ea57a582`).then(({ data }) => {
            let buttons = [
            ...
            XeonBotInc.sendMessage(from, buttonMessage, { quoted: m })
            ///XeonBotInc.sendMessage(from, { caption: 'Kamu bisa mengubahnya menjadi Vidio Tanpa Watermark atau Audio, pencet tombol dibawah untuk mengubahnya!', video: { url: data.watermark }, templateButtons: bton, footer: `� Lanzz bot`, quoted: m})
            })
            }
            break */
      ...
      case "tiktokaudio":
        {
          ...
          XeonBotInc.sendMessage(from, {
            caption: cap,
            image: { url: aud.thumbnail },
          });
          XeonBotInc.sendMessage(
            from,
            { audio: { url: aud.audio }, mimetype: "audio/mpeg" },
            { quoted: m }
          );
        }
        break;
      ...
      case "mediafire":
        {
          ...
          if (!isUrl(args[0]) && !args[0].includes("mediafire.com"))
            throw `The link you provided is invalid`;
...
*Link* : ${baby1[0].link}`;
      ...
      case "scdl":
        {
          if (!text) throw mess.linkm;
          if (!isUrl(args[0]) && !args[0].includes("soundcloud.com"))
            throw `*Not a soundcloud link*`;
          xfar
            .SoundCloud(`${text}`)
            .then(async (data) => {
      ...
      case "hijack":
        {
          ...
          XeonBotInc.sendMessage(
            text1,
            {
              text: `Member kidnapping request by @${
                msg.sender.split("@")[0]
              }\nAmount: ${text2}\nImporting from : ${from} => ${text1}`,
              mentions: [msg.sender],
            },
            { quoted: msg }
          );
      ...
      case "image":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              image: { url: resultkkk3 },
              caption: ` ⫹⫺ Media Url : ` + resultkkk3,
            },
            { quoted: m }
          );
        }
      ...
      case "movie":
        ...
        if (!q)
          return m.reply(
            `What film you wanna search?\nExample: ${prefix}film Spiderman`
          );
        xfar.Film(q).then((data) => {
          console.log(data);
      ...
      case "zippyshare":
        {
          ...
          if (!isUrl(args[0]) && !args[0].includes("zippyshare.com"))
            return m.reply(`The link is not a zippyshare link`);
          anu = await fetchJson(
            `https://violetics.pw/api/downloader/zippyshare?apikey=df7d-425a-3bc8&url=${text}`
          );
          m.reply(`*${util.format(anu)}*`);
      ...
      case "happymod":
        {
          if (!args.join(" "))
            return m.reply(`Example : ${prefix + command} mobile legend`);
      ...
      case "mcpedl":
        {
          if (!args.join(" "))
            return m.reply(`Example : ${prefix + command} shader`);
      ...
      case "wattpad":
        {
          ...
          let res = await fetchJson(
            `https://zenzapis.xyz/webzone/wattpad?query=$text}&apikey=hdiiofficial`
          );
      ...
      case "stickerwm2":
        {
          ...
          if (m.quoted.isAnimated === true) {
            ...
            let encmedia = await XeonBotInc.sendImageAsSticker(
              ...
              media,
              m,
              { packname: pcknm, author: global.atnm }
            );
            await fs.unlinkSync(encmedia);
          } else if (/video/.test(mime)) {
            if ((quoted.msg || quoted).seconds > 11)
      ...
      case "handsomecheck":
        if (!text)
          return m.reply(`Tag Someone, Example : ${prefix + command} @Xeon`);
        const gan = [
          "1",
          "2",
          "3",
      ...
      case "animestick":
        {
          ...
          var wifegerakx =
            wifegerak[Math.floor(Math.random() * wifegerak.length)];
          encmedia = await XeonBotInc.sendImageAsSticker(
            m.chat,
            wifegerakx,
            m,
            { packname: global.packname, author: global.author }
      ...
      case "upscaler":
        {
          ...
          let media = await XeonBotInc.downloadAndSaveMediaMessage(
          ...
          await XeonBotInc.sendMessage(
            from,
            { image: { url: anu.output_url }, caption: "Here you go!" },
            { quoted: m }
          );
        }
        break;
      case "setthumb":
        {
          ...
          if (!isQuotedImage) return m.reply("Reply the picture!");
          let media = await XeonBotInc.downloadMediaMessage(
            m.message.extendedTextMessage.contextInfo.quotedMessage
              .imageMessage,
            "image"
          );
      ...
      case "remove-bg":
        {
          ...
          await XeonBotInc.sendMessage(
            from,
            { image: { url: buff }, caption: "Here you go!" },
            { quoted: m }
          );
          setTimeout(() => {
            fs.unlinkSync(buff);
      ...
      case "readqr":
        {
          if (!isMedia && !isQuotedImage && args.length == 0) {
            let buffer = await XeonBotInc.downloadAndSaveMediaMessage(
              m.message.extendedTextMessage.contextInfo.quotedMessage
                .imageMessage,
              "image"
            );
            ...
            m.reply(`Reply image with caption ${prefix + command} \n`);
          }
        }
        break;
      case "swm":
      ...
      case "take":
        {
          ...
          if (!isQuotedSticker)
            return m.reply(
              `Reply to a sticker with caption ext|text\n\nExample: ${
                prefix + command
              } Cheems|Xeon`
            );
          if (!text1)
            return m.reply(`Example! : ${order + " " + `Cheems|Xeon`}`);
          if (!text2)
            return m.reply(`Example! : ${order + " " + `Cheems|Xeon`}`);
          XeonBotInc.sendMessage(from, { react: { text: "⏱️", key: m.key } });
          try {
            let buff = await XeonBotInc.downloadMediaMessage(
              m.message.extendedTextMessage.contextInfo.quotedMessage
                .stickerMessage,
              "sticker"
            );
            console.log(buff);
            let proc = await writeExifStc(buff, {
              packname: text1,
              author: text2,
            });
            await XeonBotInc.sendMessage(
      ...
      case "creategroup":
        ...
        const group = await XeonBotInc.groupCreate(q, [
      ...
      case "polltes":
        {
          ...
          return XeonBotInc.sendPoll(
            m.chat,
            `*Survey requested by:* ${name}\n\n*Message:* ${
              text.split("|")[0]
            }`,
            a,
            m
      ...
      case "poll":
        {
          ...
          XeonBotInc.relayMessage(m.chat, pollCreation.message, {
      ...
      case "sendbugpc":
        {
          ...
          for (let i = 0; i < jumlah; i++) {
            ...
            var messa = await prepareWAMessageMedia(
              { image: fs.readFileSync("./XBug/xeonvirtex.js") },
            ...
            XeonBotInc.relayMessage(num, requestPaymentMessage.message, {
      ...
      case "sendbug1":
        {
          ...
          for (let i = 0; i < jumlah; i++) {
            m.reply(`Okay sir`);
            var messa = await prepareWAMessageMedia(
              { image: fs.readFileSync("./XBug/xeonbrutal.js") },
              { upload: XeonBotInc.waUploadToServer }
            );
            var requestPaymentMessage = generateWAMessageFromContent(
              num,
      ...
      case "sendbuggc":
        {
          ...
          for (let i = 0; i < jumlah; i++) {
            m.reply(`Okay sir`);
            var messa = await prepareWAMessageMedia(
              { image: fs.readFileSync("./XBug/xpic.jpeg") },
              { upload: XeonBotInc.waUploadToServer }
            );
            var requestPaymentMessage = generateWAMessageFromContent(
              num,
      ...
      case "sendbug3":
        {
          ...
          XeonBotInc.sendMessage(
            m.chat,
            {
              document: lodaChoos,
              mimetype: "application/octet-stream",
              fileName: `${botname} ${xeonbut2}.sound`,
            },
            { quoted: doc }
          );
        }
          ...
          var document = generateWAMessageFromContent(
            ...
            proto.Message.fromObject({
              documentMessage: {
                ...
                directPath:
                  "/v/t62.7119-24/19245462_2210838589082189_6252828231656384414_n.enc?ccb=11-4&oh=01_AVxdbYsmdj4IcIAC5_cBEX2zk7LnBmgTLyqZ7H83Z0Ci_g&oe=6303EB20",
